...
const Shopping = () => {
    return (
        <div
            ...
            className='w-full flex flex-col bg-[#E24B26] pt-[80px] lg:px-0 px-[24px] text-[#FFFFFF]'
        >
            <div className='lg:w-[746px] mx-auto text-center flex flex-col items-center gap-[32px]'>
                ...
                <p className='text-[#52525B] text-center'>Transform your grocery shopping experience with GroceryChamp – the intelligent mobile app that organizes your lists, tracks your spending, and remembers your favorite stores.</p>
